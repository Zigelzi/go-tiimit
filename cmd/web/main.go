...
func main() {
	...
	mux.Handle("GET /practices/{id}", requireAuth(http.HandlerFunc(cfg.handleViewPracticePage)))
	mux.Handle("GET /practices/{practice_id}/teams/{team_number}", requireAuth(http.HandlerFunc(cfg.handleViewTeam)))
