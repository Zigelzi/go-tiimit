...
function initPostHog(apikey, user) {
  posthog.init(apikey, {
    ...
    loaded: (posthog) => {
      ...
      } else if (posthog.get_property("$user_id") !== undefined) {
        posthog.reset();
      }
    },
  });
